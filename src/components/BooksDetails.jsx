...
export default function BooksDetails() {
  ...
  return (
    <div
      className="w-full px-6 py-16 md:py-24 bg-gradient-to-r from-teal-500 via-cyan-500 to-sky-500 text-white rounded-3xl shadow-xl"
      data-aos="zoom-in"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16" data-aos="fade-up" data-aos-delay="200">
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            ...
            <h4 className="text-xl font-semibold mb-2">Publicación Sin Costo</h4>
            <p className="text-blue-50/80">Publica gratis sin tarifas ocultas</p>
          </div>
          
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            <Hash size={40} className="text-yellow-300 mx-auto mb-4" />
            <h4 className="text-xl font-semibold mb-2">ISBN y DOI</h4>
            <p className="text-blue-50/80">Identificadores académicos disponibles</p>
          </div>
          
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            <Globe size={40} className="text-purple-300 mx-auto mb-4" />
            <h4 className="text-xl font-semibold mb-2">Distribución Global</h4>
            <p className="text-blue-50/80">Alcance mundial para tu obra</p>
          </div>
        </div>
