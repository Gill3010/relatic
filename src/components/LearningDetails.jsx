...
export default function LearningDetails() {
  ...
  return (
    <div
      className="w-full px-6 py-16 md:py-24 bg-gradient-to-r from-teal-500 via-sky-500 to-blue-600 text-white rounded-3xl shadow-xl"
      data-aos="zoom-in"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16" data-aos="fade-up" data-aos-delay="200">
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            <Play size={40} className="text-green-300 mx-auto mb-4" />
            <h4 className="text-xl font-semibold mb-2">Cursos Flexibles</h4>
            <p className="text-blue-50/80">Asincrónicos y en vivo para tu conveniencia</p>
          </div>
          
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            <GraduationCap size={40} className="text-yellow-300 mx-auto mb-4" />
            <h4 className="text-xl font-semibold mb-2">Certificados Oficiales</h4>
            <p className="text-blue-50/80">Reconocimiento formal de tu aprendizaje</p>
          </div>
          
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            <MapPin size={40} className="text-orange-300 mx-auto mb-4" />
            <h4 className="text-xl font-semibold mb-2">Expertos Latinoamericanos</h4>
            <p className="text-blue-50/80">Instructores de excelencia regional</p>
          </div>
        </div>
