  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="group bg-white p-6 rounded-lg shadow-lg border-4 border-[#68358c] transform transition-transform duration-300 hover:scale-105 hover:bg-gradient-to-r hover:from-[#68358c] hover:to-[#2d2e77]">
        ...
        <h2 className="text-3xl font-semibold text-center text-[#68358c] mb-6 group-hover:text-white">Plataforma Integral de Aprendizaje Continuo</h2>
        <h3 className="text-xl font-semibold text-[#68358c] mb-4 group-hover:text-white">
          <strong className="text-[#68358c] group-hover:text-white">¿Cómo transformamos el aprendizaje continuo con soluciones personalizadas, interactivas y accesibles para todos los niveles de conocimiento?</strong>
        </h3>
