...
export default function IntellectualPropertyDetails() {
  ...
  return (
    <div
      className="w-full px-6 py-16 md:py-24 bg-gradient-to-r from-sky-600 via-cyan-600 to-blue-700 text-white rounded-3xl shadow-xl"
      data-aos="zoom-in"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16" data-aos="fade-up" data-aos-delay="200">
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            <FileText size={40} className="text-green-300 mx-auto mb-4" />
            <h4 className="text-xl font-semibold mb-2">Registro Legal</h4>
            <p className="text-blue-50/80">Propiedad intelectual protegida oficialmente</p>
          </div>
          
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            <UserCheck size={40} className="text-yellow-300 mx-auto mb-4" />
            <h4 className="text-xl font-semibold mb-2">Asesoría Personalizada</h4>
            <p className="text-blue-50/80">Acompañamiento experto en cada proceso</p>
          </div>
          
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            <Map size={40} className="text-purple-300 mx-auto mb-4" />
            <h4 className="text-xl font-semibold mb-2">Cobertura Regional</h4>
            <p className="text-blue-50/80">Protección en toda Latinoamérica</p>
          </div>
        </div>
