...
export default function JournalsDetails() {
  ...
  return (
    <div
      className="w-full px-6 py-16 md:py-24 bg-gradient-to-r from-sky-600 via-cyan-500 to-blue-500 text-white rounded-3xl shadow-xl"
      data-aos="zoom-in"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16" data-aos="fade-up" data-aos-delay="200">
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            <CheckCircle size={40} className="text-green-300 mx-auto mb-4" />
            <h4 className="text-xl font-semibold mb-2">Acceso Abierto</h4>
            <p className="text-blue-50/80">Revistas científicas disponibles para todos</p>
          </div>
          
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            <Star size={40} className="text-yellow-300 mx-auto mb-4" />
            <h4 className="text-xl font-semibold mb-2">Proceso Transparente</h4>
            <p className="text-blue-50/80">Editorial claro y riguroso</p>
          </div>
          
          <div className="bg-white/15 backdrop-blur-lg p-6 rounded-2xl text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
            <Users size={40} className="text-purple-300 mx-auto mb-4" />
            <h4 className="text-xl font-semibold mb-2">Difusión Internacional</h4>
            <p className="text-blue-50/80">Alcance global para tu investigación</p>
          </div>
        </div>
