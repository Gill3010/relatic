    ...
    <section className="bg-azulOscuro py-16">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="service-card bg-verdeBoton text-center py-8 px-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-2">
            <img src={Desarrollo2} alt="Desarrollo de aplicaciones web" className="mx-auto mb-6 w-32 h-20" />
          ...
          <div className="service-card bg-verdeBoton text-center py-8 px-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-2">
            <img src={Integracion} alt="Integración de APIs" className="mx-auto mb-6 w-32 h-20" />
          ...
          <div className="service-card bg-verdeBoton text-center py-8 px-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-2">
            <img src={Cpanel} alt="Soporte en cPanel" className="mx-auto mb-6 w-32 h-20" />
          ...
          <div className="service-card bg-verdeBoton text-center py-8 px-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-2">
            <img src={Seo} alt="SEO para tu sitio web" className="mx-auto mb-6 w-32 h-20" />
