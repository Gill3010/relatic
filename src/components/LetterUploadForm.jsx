...
const LetterUploadForm = ({ events, isLoading, onAssetsUploaded }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('letter_logo', logoFile);
        formData.append('letter_signature', signatureFile);

        try {
            const response = await fetch('https://relaticpanama.org/api/process_excel_upload_letter.php', {
                method: 'POST',
                body: formData,
            });
            ...
            setSubmitStatus({
                ...
                message: result.message || (result.success ? 'Activos subidos correctamente.' : 'Error al subir los activos.')
            });
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-8">
            ...
            <div className="mt-8 pt-8 border-t border-slate-200">
                ...
                <ul className="text-sm text-slate-600 space-y-1">
                    <li>• Seleccione el evento al que desea asociar los activos.</li>
                    <li>• Seleccione un archivo de imagen (.jpg, .png) para el logo de las cartas.</li>
                    <li>• Seleccione un archivo de imagen (.jpg, .png) para la firma de las cartas.</li>
