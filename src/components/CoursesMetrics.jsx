...
const CoursesMetrics = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://relaticpanama.org/_events/api/coursesMetrics.php')
      .then(res => res.json())
      .then(data => {
  ...
  const cards = [
    { label: 'Cursos', value: metrics.courses },
    { label: 'Profesores', value: metrics.teachers },
    {
      label: 'Años Activos',
  ...
  const pieData = [
    { name: 'Cursos', value: metrics.courses },
    { name: 'Profesores', value: metrics.teachers },
  ];
