  ...
  useEffect(() => {
    ...
    styleElement.textContent = `
      ...
      @media (max-width: 1024px) and (orientation: landscape) and (max-height: 600px) {
        ...
        .mobile-landscape-nav-btn svg {
          width: 18px !important;
          height: 18px !important;
        }
        
        .mobile-landscape-indicators {
          bottom: 8px !important;
        }
        
        .mobile-landscape-indicators button {
          width: 6px !important;
      ...
      /* Ajuste adicional para asegurar que el contenido no se corte */
            ...
            >
              ...
              <div className="relative z-20 h-full flex items-center justify-center px-8 mobile-landscape-container">
                <div className="text-center max-w-4xl mobile-landscape-content carousel-slide-content">
                  ...
                  <div className={`mb-8 transform transition-all duration-1000 delay-300 mobile-landscape-icon ${isActive ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-8 opacity-0 scale-90'}`}>
                    <div className="w-20 h-20 mx-auto bg-blue-600/90 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/20 mobile-landscape-icon">
                      <IconComponent size={40} className="text-white" />
                    </div>
                  </div>

                 {/* Título principal */}
                  <h1 className={`text-6xl md:text-7xl font-bold mb-4 ${slide.textColor} transition-all duration-1000 delay-500 mobile-landscape-title
                  ...
                  {/* Subtítulo */}
                  <h2 className={`text-2xl md:text-3xl font-light mb-6 text-white/90 transition-all duration-1000 delay-700 mobile-landscape-subtitle
                    ${isActive ? 'translate-y-0 opacity-90 animate-zoom-in' : 'translate-y-8 opacity-0'}`}>
                    {slide.subtitle}
                  </h2>

                  {/* Descripción */}
                  <p className={`text-lg md:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed transition-all duration-1000 delay-900 mobile-landscape-description
                  ...
                  <a href={slide.href} rel="noopener noreferrer">
                    <button
                      className={`
                        mt-8 px-8 py-3 rounded-lg font-semibold text-white text-lg transform hover:scale-105 transition-all duration-300 mobile-landscape-button
