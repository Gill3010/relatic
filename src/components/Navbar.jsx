    ...
    <nav className="bg-gradient-to-r from-[#1a1b59] via-[#1a3aa0] to-[#1a8fe3] text-[#FFFF] py-4 shadow-lg sticky top-0 z-50 border-b-4 border-[#FFD700]">
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-8 text-lg">
          <a href="/inicio" className="hover:text-[#ffc107] transition-colors duration-300">Inicio</a>
          <a href="/nosotros" className="hover:text-[#ffc107] transition-colors duration-300">Nosotros</a>

          {/* Servicios */}
          <div className="relative">
            <button onClick={toggleSubMenu} className="hover:text-[#ffc107] transition-colors duration-300 focus:outline-none">
              Servicios
            </button>
            {isSubMenuOpen && (
          ...
          {/* Actividades */}
          <div className="relative">
            <button onClick={toggleActivitiesSubMenu} className="hover:text-[#ffc107] transition-colors duration-300 focus:outline-none">
              Actividades
            </button>
          ...
          <a href="/contactus" className="hover:text-[#ffc107] transition-colors duration-300">Contacto</a>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-gradient-to-r from-[#1a1b59] via-[#1a3aa0] to-[#1a8fe3] text-[#FFFF] mt-4">
          <div className="flex flex-col items-center space-y-4 py-4">
            ...
            <a href="/contactus" className="hover:text-[#ffd700] transition-colors duration-300" onClick={toggleMenu}>Contacto</a>
